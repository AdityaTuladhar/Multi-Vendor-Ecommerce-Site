...
function deleteEntryFunction($id_to_delete) {
    ...
    $delete_query = "DELETE FROM user_info WHERE id=$id_to_delete";
...
function updateEntryFunction() {
    ...
    $update_query = "UPDATE user_info SET name='$name', email='$email', phone='$phone', password='$password' WHERE id='$id'";
...
function insertEntryFunction() {
    ...
    $phone=$_GET["phone"];
    $password=$_GET["password"];
    $insert_query = "INSERT INTO user_info(name,email,phone,password) VALUES ('$name','$email','$phone','$password')";
...
<body>
  ...
  <div id="app">
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($result)){
                                    if (isset($_GET['id_to_edit']) && ($_GET['id_to_edit'] == $row['id'])) {
                                        ...
                                        <td><input type='text' id='password".$row['id']."' value='".$row['password']."'></td>
                                        <td>
                                            <!-- Call to action buttons -->
                                            <ul class='list-inline m-0'>
                                                <li class='list-inline-item'>
    ...
    <script type="text/javascript">
        ...
        function onEdit(id){
            window.location.href="admin_trans_list.php?id_to_edit="+id;
        }

        function onDelete(id){
            window.location.href="admin_trans_list.php?id_to_delete="+id;
        }

        function onAdd(){
            window.location.href="admin_trans_list.php?add_entry=true";
        }
        ...
        function onSaveAdd(){
            ...
            window.location.href="admin_trans_list.php?save_add=true&name="+name+"&email="+email+"&phone="+phone+"&password="+password;
        }
        ...
        function onSaveEdit(id){
            ...
            window.location.href="admin_trans_list.php?id_to_save="+id+"&name="+name+"&email="+email+"&phone="+phone+"&password="+password;
        }
    </script>
</body>
